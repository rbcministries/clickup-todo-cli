...
**6b. In-text link styling on WRAPPED lines (#413 + #443)** — the wrapped-line case check 6 deliberately
avoids (it fixes `COLS=120` so URLs don't wrap). Runs at a narrow `COLS=50` and covers two wrap cases:
