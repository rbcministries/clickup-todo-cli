...
public sealed class FeedCache
{
    ...
    public CachedSnapshot<CommentItem>? LoadSnapshot(AppConfig config)
    {
        ...
        // Age-based eviction (#124): a structurally-invalid timestamp (hand-tampered file) or a feed at
        // or beyond the max age is a miss, and the stale document is pruned so it doesn't linger. The
