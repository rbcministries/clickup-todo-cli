...
{
    /// <summary>The next tab in the F2 cycle, looping Stream → Description → Comments → Other → Stream.</summary>
    ...
    /// Other). Kept as an explicit map — rather than a raw cast — so a future reordering of either the
    /// enum or the screen's tabs is a deliberate, test-visible change.
    /// </summary>
