...
/// (#123), the per-list status/color metadata (#125), the assignee-frequency pool (#155), the warm
/// closed-task set (#280), and the Super Agent directory (#494) — so <c>--reset</c> / <c>--logout</c>
/// leaves no cache behind for a different account or workspace.
