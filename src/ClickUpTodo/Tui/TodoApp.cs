...
public sealed class TodoApp
{
        ...
        IQuickUpdateTarget target, TaskDetailScreen? detailOrigin = null)
    {
        ...
        var screen = new QuickUpdatesScreen(
            ...
            // immediately via ApplyListAsync over the #237 membership writes. List membership isn't shown
            // on the main-list row, so — unlike Status/Priority/Assignees (#297) — it needs no target.
