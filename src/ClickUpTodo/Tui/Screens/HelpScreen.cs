    ...
    public HelpScreen()
    {
        ...
        var body = new Label
        {
            ...
            Text =
                ...
                + "  Click       In the detail view: click a link in the text to follow it — a ClickUp task\n"
                + "              link opens that task here (Esc walks back), any other link opens in your\n"
                + "              browser; Ctrl+Left-Click always opens in the browser\n"
                ...
                + "  Ctrl+E      Open the mentions & comments feed (in the feed: Enter opens the task, F3 shows\n"
                + "              mentions only, F12 includes completed tickets' activity)\n"
                ...
                + "  F12         Cycle completed: active only → + done → + done & closed (applies to subtasks too)\n"
