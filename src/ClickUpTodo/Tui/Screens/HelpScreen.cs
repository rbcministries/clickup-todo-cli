    ...
    public HelpScreen()
    {
        ...
        var body = new Label
        {
            ...
            Text =
                ...
                + "  Ctrl+Q/Esc        Quit — confirms first by default (Y/Enter exits, N/Esc stays; F10 to turn off)\n"
                + "\n"
                + "  TASK DETAIL VIEW\n"
                ...
                + "  Ctrl+B        🌐  Open the task in your browser\n"
                + "  Click             Follow a link in the text — a ClickUp task link opens that task\n"
                + "                    here (Esc walks back), any other link opens in your browser;\n"
                + "                    Ctrl+Left-Click always opens in the browser\n"
