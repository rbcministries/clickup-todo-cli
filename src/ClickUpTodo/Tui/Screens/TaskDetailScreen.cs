...
/// ↑/↓/PgUp/PgDn scroll the focused pane. The Stream tab (#106) is the default; Ctrl+PgUp/Ctrl+PgDn
/// sort it oldest-first / newest-first and re-render it in place. Tab bodies come from the unit-tested
...
public sealed class TaskDetailScreen : Screen
{
    ...
    public TaskDetailScreen(TaskDetail task, IReadOnlyList<CommentItem> comments)
    {
        ...
        _scrollTargets = [_streamPane, description, commentsPane, customFields];
