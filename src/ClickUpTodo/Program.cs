...
// The list-frequency candidate pool (#238) — warmed from the loaded tasks (free) and backfilled by the
// scheduled list-hierarchy walk (#236) — rides the same state store, scoped to the active workspace.
