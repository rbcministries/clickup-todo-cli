...
// The list-frequency candidate pool (#238) — warmed from the loaded tasks (free) and seeded in the
// long tail by the scheduled list-hierarchy walk (#236) — rides the same state store, per workspace.
